...
//            int k = 0;
    ...
    private void setApplicationProperties() {
        ...
        props.setProperty("rasterCartographicGeneralizationLevel", Double.toString(rasterCartographicGeneralizationLevel));
        props.setProperty("vectorCartographicGeneralizationLevel", Double.toString(vectorCartographicGeneralizationLevel));
...
//            toolsMenu.addSeparator();
    ...
    private String[][] findTutorialFiles() {
        ...
        try {
            ...
            logException("Help.findAvailableHelpFiles Error", e);
        } finally {
    ...
    public void addLayer(String fileName) {
        try {
            ...
            if (extension.equals("dep")) {
                ...
                newLayer.setCartographicGeneralizationLevel(rasterCartographicGeneralizationLevel);
                ...
                newLayer.setCartographicGeneralizationLevel(vectorCartographicGeneralizationLevel);
                activeMapArea.addLayer(newLayer);
                newLayer.setOverlayNumber(activeMapArea.getNumLayers() - 1);
...
//        showMapProperties(i);
    ...
    private void showAttributesFile() {
        ...
        if (ma.getLayer(layerOverlayNum).getLayerType() == MapLayerType.VECTOR) {
            ...
            AttributesFileViewer afv = new AttributesFileViewer(this, false, vli);
